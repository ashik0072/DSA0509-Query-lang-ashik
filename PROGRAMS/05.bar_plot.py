...
# Plotting bar plot for trading volume
plt.figure(figsize=(20, 16))
plt.bar(filtered_stock_df['Date'], filtered_stock_df['Volume'], color='yellow')
plt.title('Alphabet Inc. Trading Volume between {} and {}'.format(start_date, end_date))
plt.xlabel('Date')
